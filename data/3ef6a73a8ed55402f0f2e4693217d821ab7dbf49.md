...
- Name: List LicenseTemplates @Licenses >> query with default
- Location: /home/runner/work/api-integration-tests/api-integration-tests/tests/api/licenses/licenses-templates.post.spec.ts:6:7
...
Expected: 200
Received: 530
    at /home/runner/work/api-integration-tests/api-integration-tests/tests/api/licenses/licenses-templates.post.spec.ts:8:31
```
...
```ts
   ...
   4 |
   5 | test.describe("List LicenseTemplates @Licenses", () => {
...
>  8 |     expect(response.status()).toBe(200);
  ...
  16 |     expect(typeof data[0].metadataUri).toBe("string");
  ...
  20 |     expect(data[0].name).toBeTruthy();
  21 |     expect(data[0].metadataUri).toBeTruthy();
  ...
  56 |       if (pagination.offset < licensesTemplates.length) {
  57 |         expect(data[0]).toMatchObject(firstItem);
  58 |       }
  59 |     });
  60 |   }
  61 | });
